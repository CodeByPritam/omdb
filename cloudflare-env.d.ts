/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 5aba8bac9166fcac5231fc39f5754988)
// Runtime types generated with workerd@1.20260917.1 2026-09-16 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* omdb */;
}
